...
import { MenuIcon, ArcReactorLogo, CogIcon } from './Icons';
...
export const Header: React.FC<HeaderProps> = ({ toggleSidebar, isSidebarOpen, toggleRightPanel, isRightPanelOpen }) => {
